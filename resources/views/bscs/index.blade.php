    ...
    <div x-data="bscsPage()" x-init="init()" class="pb-12">
        ...
        <div class="flex items-center justify-between gap-3 mb-5 flex-wrap">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-2xl font-bold ui-text leading-tight">Black Swan Composite Score</h1>
                    <p class="ui-text-muted text-xs">Live regime detection · updates hourly at :50 UTC</p>
                </div>
            </div>
            <button type="button"
